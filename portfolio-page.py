...
with st.container():
    ...
    with col1:
        ...
        st.subheader(
            """
            This page is actually made with Python 🐍 and the associated Streamlit library. Even though the purpose of this library is mainly data science, this page is made to showcase that even with no knowledge of Web Development you can make a nice looking portfolio page with pure Python code.
            """
        )
    with col2:
        st_lottie(
